...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { email: @good.email, itemsdonate: @good.itemsdonate, name: @good.name, phone: @good.phone } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { email: @good.email, itemsdonate: @good.itemsdonate, name: @good.name, phone: @good.phone } }

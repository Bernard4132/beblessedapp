...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { areastohelp: @volunteer.areastohelp, email: @volunteer.email, name: @volunteer.name, phone: @volunteer.phone, whyhelp: @volunteer.whyhelp } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { areastohelp: @volunteer.areastohelp, email: @volunteer.email, name: @volunteer.name, phone: @volunteer.phone, whyhelp: @volunteer.whyhelp } }
